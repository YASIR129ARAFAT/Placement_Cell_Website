        ...
        <div class="content">
            ...
            <div class="security-advice">
                ...
                <ul>
                    ...
                    <li><strong>Enable two-factor authentication:</strong> If available, activate this feature for an extra layer of security.</li>
                    <li><strong>Keep your credentials confidential:</strong> Never share your login information with anyone.</li>
                    <li><strong>Be cautious of phishing attempts:</strong> We will never ask for your password via email or phone.</li>
                </ul>
            </div>
